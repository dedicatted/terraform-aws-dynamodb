...
Configuration in this directory creates AWS DynamoDB table with autoscaling using official [AWS terraform module](https://github.com/terraform-aws-modules/terraform-aws-dynamodb-table). Be sure to read [the note](https://github.com/terraform-aws-modules/terraform-aws-dynamodb-tableREADME.md#Notes) about autoscaling settings causing the table to be recreated.
